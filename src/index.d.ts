...
import { INodeRequestOptions } from '@waves/node-api-js/cjs/nodeInteraction';
import { TxStatus } from '@waves/node-api-js/cjs/nodeInteraction';
...
/// NODE INTERACTION
     ...
     * ```
     */
    export function waitForTx(txId: string, options?: INodeRequestOptions, requestOptions?: RequestInit): Promise<TxStatus>

    /**
     * Resolves N blocks after specified txId is mined into the block
     * By default has 20s timeout and uses current environment node
     */
    export function waitForTxWithNConfirmations(txId: string, confirmations: number, options?: INodeRequestOptions, requestOptions?: RequestInit): Promise<TxStatus>
     ...
     */
    export function transactionById(txId: string, apiBase?: string, requestOptions?: RequestInit): Promise<Transaction & WithId & {
        height: number;
    }>;
...
// UTILITY
    ...
    /**
     * Waves-crypto library https://www.npmjs.com/package/@waves/ts-lib-crypto
     * Available in global scope:
     * ```js
     * const addressBytes = crypto.base58Decode('3N77yhDrPTdLFjzNPZcBQPZLDg11EHAB7xF')
     * ```
     */
    export namespace wavesCrypto {
