 ...
 * ```
 */
declare function waitForTx(txId: string, options?: INodeRequestOptions): Promise<TTx>

/**
 * Resolves N blocks after specified txId is mined into the block
 * By default has 20s timeout and uses current environment node
 */
declare function waitForTxWithNConfirmations(txId: string, confirmations: number, options?: INodeRequestOptions): Promise<TTx>
 ...
 * By default uses current environment address and node
 */
declare function accountData(address?: string, apiBase?: string): Promise<Record<string, IDataEntry>>

/**
 * Get data from account dictionary by key
 * By default uses current environment address and node
 */
declare function accountDataByKey(key: string, address?: string, apiBase?: string): Promise<IDataEntry>
